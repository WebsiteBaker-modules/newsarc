...
// $Id: save_settings.php 399 2006-12-24 07:50:44Z Ruebenwurzel $
...
// Update settings
$database->query("UPDATE ".TABLE_PREFIX."mod_newsarc_settings SET header = '$header', post_loop = '$post_loop', footer = '$footer', posts_per_page = '$posts_per_page', post_header = '$post_header', post_footer = '$post_footer', comments_header = '$comments_header', comments_loop = '$comments_loop', comments_footer = '$comments_footer', comments_page = '$comments_page', commenting = '$commenting', resize = '$resize', use_captcha = '$use_captcha' WHERE section_id = '$section_id'");
